...
calificacionesFor = [{"titulo": pelicula["Titulo"], "calificacion": pelicula["CalificaciónIMDB"]} for pelicula in pelis]
calificacionesMap = list(map(lambda pelicula: {"titulo": pelicula["Titulo"], "calificacion": pelicula["CalificaciónIMDB"]}, pelis))
